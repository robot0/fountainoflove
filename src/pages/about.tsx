				...
				<section className="relative bg-white py-0 sm:py-24">
					<div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
						...
						<div className="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:px-0">
							{/* Content area */}
							<div className="">
								<h2 className="mb-6 text-4xl font-sans font-bold tracking-tight text-gray-900 sm:text-6xl">
									Our Mission
								</h2>
								...
								<dl className="grid grid-cols-2 gap-x-4 gap-y-8">
									{stats.map((stat) => (
										<div key={stat.label} className="border-t-2 border-gray-100 pt-6">
											<dt className="text-base font-sans font-medium text-gray-500">
												{stat.label}
											</dt>
											<dd className="text-3xl font-sans font-bold tracking-tight text-gray-900">
												{stat.value}
											</dd>
										</div>
									))}
					...
					<div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
						...
						<div className="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:px-0">
							...
							<div className="pt-12 sm:pt-16 lg:pt-20">
								<h2 className="text-6xl font-sans font-bold tracking-tight text-gray-900 sm:text-4xl">
									Company Values
								</h2>
								<div className="mt-6 space-y-6 font-sans text-gray-500">
