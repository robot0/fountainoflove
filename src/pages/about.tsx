							...
							<div className="grid grid-cols-1 items-center gap-y-10 gap-x-16 lg:grid-cols-2">
								<div>
									...
									<p className="mt-4 text-gray-500">
										...
										if we kinda stopped caring about that. Our new strategy is to write a bunch of
										things that look really good in the headlines, then clarify in the small print
										but hope people do not actually read it.
									</p>
								</div>
